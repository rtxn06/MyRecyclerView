    ...
    object HeroesData{
        private val data = arrayOf(
            ...
            arrayOf(
                ...
                "https://upload.wikimedia.org/wikipedia/commons/b/be/Col_Gatot_Subr oto%2C_Kenang- Kenangan_Pada_Panglima_Besar_Letnan_Djenderal_Soedirman%2C_p27.jpg"
            ),

            arrayOf(
                "Ki Hadjar Dewantara",
                "Raden Mas Soewardi Soerjaningrat (EBI: Suwardi Suryaningrat, sejak 1922 menjadi Ki Hadjar Dewantara, EBI: Ki Hadjar Dewantara, beberapa menuliskan bunyi bahasa Jawanya dengan Ki Hadjar Dewantaro; lahir di Pakualaman, 2 Mei 1889 - meninggal di Yogyakarta, 26 April 1959 pada umur 69 tahun; selanjutnya disingkat sebagai \"Soewardi\" atau \"KHD\") adalah aktivis pergerakan kemerdekaan Indonesia, Komunis, Politisi, dan pelapor pendidikan bagi kaum pribumi Indonesia dari zaman penjajahan Belanda. Ia adalah pendiri perguruan Taman Siswa, suatu lembaga pendidikan yang memberikan kesempatan bagi para pribumi untuk bisa memperoleh hak pendidikan seperti halnya para priyayi maupun orang-orang Belanda.",
                "https://upload.wikipedia.org/wikipedia/commons/3/3a/Ki_Hadjar_Dewantara_Mimbar_Umum_18_October_1949_p2.jpg"
            ),

            arrayOf(
                "Mohammad Hatta",
                "Dr.(HC) Drs. H. Mohammad Hatta (lahir dengan nama Mohammad Athar, dikenal sebagai Bung Hatta; lahir di Fort de Kock (sekarang Bukittinggi, Sumatera Barat), Hindia Belanda, 12 Agustus 1902 - meninggal di Jakarta, 14 Maret 1980 pada umur 77 tahun) adalah tokoh pejuang, negarawan, ekonom, dan juga Wakil Presiden Indonesia yang pertama. Ia bersama Soekarno memainkan peran penting untuk memerdekakan bangsa Indonesia dari penjajahan Belanda sekaligus memproklamasikannya pada 17 Agustus 1945. Ia juga pernah menjabat sebagai Perdana Menteri dalam Kabinet Hatta I, Hatta II, dan RIS. Ia mundur dari jabatan wakil presiden pada tahun 1956, karena berselisih sengan Presiden Soekarno. Hatta juga dikenal sebagai Bapak Koperasi Indonesia.",
                "https://upload.wikipedia.org/wikipedia/commons/thumb/3/3b/VP_Hatta.jpg/330px-VP_Hatta.jpg"
            ),
